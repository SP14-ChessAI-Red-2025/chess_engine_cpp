...
namespace chess::ai {
    ...
    private:
         ...
         * Piece types are ordered: P, N, B, R, Q, K (white), p, n, b, r, q, k (black).
        ...
        const char* input_node_name_ = "input";   // Default, adjust if your model differs
        const char* output_node_name_ = "output"; // Default, adjust if your model differs
